<h2>1493. Longest Subarray of 1's After Deleting One Element</h2><h3>Medium</h3><hr><div><p>Given a binary array <code>nums</code>, you should delete one element from it.</p>
